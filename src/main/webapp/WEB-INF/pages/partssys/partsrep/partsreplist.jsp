...
<div class="content-pages-wrap">
	...
	<input type="button" class="btnNormal" value="配件出入库" onclick="location.href='${pageContext.request.contextPath }/pages/partssys/partsrep/partsrep'"/>	
    ...
    <table width="101%" border="0" cellpadding="0" cellspacing="1" class="commonTable">
        ...
        <c:forEach items="${repPageInfo.list }" var="pr" varStatus="i">
      		<tr>
    ...
    <div id="pagelist">
    	<ul class="clearfix">
        	   	<li><a href="${repPageInfo.firstPage}">首页</a></li>
        	<c:if test="${repPageInfo.pageNum>repPageInfo.firstPage}">
        	<li ><a href="${ repPageInfo.prePage}">上页</a></li>
        	</c:if>
        	
            <c:if test="${repPageInfo.pageNum<repPageInfo.lastPage }">
            <li><a href="${ repPageInfo.nextPage}">下页</a></li>
            </c:if>
            
            <li class="current"><input type="text" value="${repPageInfo.pageNum  }" id="pagenum"  style="text-align:right" size="1"></li>
            <li><a htrf="#" id="turn" value="跳转" onclick="javascript:btnclick();">跳转</a></li>
            <li><a href="${ repPageInfo.lastPage}">尾页</a></li>
            <li class="pageinfo">第${repPageInfo.pageNum  }页</li>
            <li class="pageinfo">共${repPageInfo.pages }页</li>
        </ul>
    </div>
</div>
<!--//content pages wrap-->
