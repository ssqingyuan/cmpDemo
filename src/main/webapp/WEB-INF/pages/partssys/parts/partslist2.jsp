...
<div class="content-pages-wrap">
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="commonTableSearch">
       	<form id="form-search" name="form-search" action="../search/1" method="post">
        <tr>
    ...
    <table width="101%" border="0" cellpadding="0" cellspacing="1" class="commonTable">
        ...
        <c:forEach items="${pageInfo2.list }" var="p" varStatus="i">
        <tr>
            ...
            <td align="center">
            	...
            	<a href="../partsedit" class="btnIconEdit" title="更新"></a>
           <a href="../partdelete?pagenum=${pageInfo2.pageNum }&partsid=${p.partsid } "  class="btnIconDel" title="删除"></a> 
    ...
    <div id="pagelist">
    	<ul class="clearfix">
        	<li><a href="${pageInfo2.firstPage}">首页</a></li>
            <c:if test="${pageInfo2.pageNum>pageInfo2.firstPage }">
        	<li ><a href="${ pageInfo2.prePage}">上页</a></li>
        	</c:if>
            <c:if test="${pageInfo2.pageNum<pageInfo2.lastPage }">
            <li><a href="${ pageInfo2.nextPage}">下页</a></li>
            </c:if>
            <li class="current"><input type="text" value="${pageInfo2.pageNum  }" id="pagenum"  style="text-align:right" size="1"></li>
            <li><a htrf="#" id="turn" value="跳转" onclick="javascript:btnclick();">跳转</a></li>
            <li><a href="${ pageInfo2.lastPage}">尾页</a></li>
            <li class="pageinfo">第${pageInfo2.pageNum  }页</li>
            <li class="pageinfo">共${pageInfo2.pages }页</li>
        </ul>
    </div>
</div>
<!--//content pages wrap-->
