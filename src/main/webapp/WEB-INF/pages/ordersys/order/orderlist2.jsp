...
<div class="content-pages-wrap">
    ...
    <table width="101%" border="0" cellpadding="0" cellspacing="1" class="commonTable">
        ...
        <c:forEach items="${opageinfo2.list }" var="l" varStatus="state">
        <tr>
            <td align="center">${(opageinfo2.pageNum-1)*opageinfo2.pageSize+state.count}</td>
           ...
           <c:if test="${l.orderflag==0 }">
            ...
            <td align="center">
                ...
                <a href="delete?orderid=${l.orderid }&pagenum=${opageinfo2.pageNum }" class="btnIconDel" title="删除"></a>
            	</c:if>
    ...
    <div id="pagelist">
    	<ul class="clearfix">
        	<li><a href="orderlist2?star=${opageinfo2.firstPage}">首页</a></li>
        	<c:if test="${opageinfo2.pageNum>opageinfo2.firstPage }">
        	<li ><a href="orderlist2?star=${ opageinfo2.prePage}">上页</a></li>
        	</c:if>
            <c:if test="${opageinfo2.pageNum<opageinfo2.lastPage }">
            <li><a href="orderlist2?star=${ opageinfo2.nextPage}">下页</a></li>
            </c:if>
            
            <li class="current"><input type="text" value=" ${opageinfo2.pageNum  }" id="pagenum"  style="text-align:right" size="1"></li>
            <li><a htrf="#" id="turn" value="跳转" onclick="javascript:btnclick();">跳转</a></li>
            <li><a href="orderlist2?star=${ opageinfo2.lastPage}">尾页</a></li>
            <li class="pageinfo">第${opageinfo2.pageNum  }页</li>
            <li class="pageinfo">共${opageinfo2.pages }页</li>
        </ul>
    </div>
</div>
