...
<div id="nav-box">
	...
	<ul id="browser" class="filetree">
		<li><span class="folder">订单模块</span>
			<ul>
            	<li><span class="file"><a onclick="urlTarget('pages/ordersys/order/orderlist?star='+1);">订单管理</a></span></li>
				<li><span class="file"><a onclick="urlTarget('pages/ordersys/order/orderchecklist?star=1');">订单审核</a></span></li>
		  </ul>
	  </li>
